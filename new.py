...
custom_objects = {'Embedding': tf.keras.layers.Embedding}  # Define custom objects if needed
model = tf.keras.models.load_model('mymodel1.h5', custom_objects=custom_objects, compile=False)
